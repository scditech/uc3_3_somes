...
METRIC_HELP: dict[str, str] = {
    ...
    "load_mae": "Stredná absolútna chyba predikcie spotreby (kW).",
    "load_rmse": "RMSE predikcie spotreby (kW).",
    "load_mape": "MAPE predikcie spotreby (%).",
    "pv_mae": "Stredná absolútna chyba predikcie výroby FVE.",
    "pv_rmse": "RMSE predikcie výroby FVE.",
    "pv_mape": "MAPE predikcie výroby FVE (%).",
